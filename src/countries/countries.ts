export default {
  countries: {
    ...
    Anguilla: ["The Valley", "Sandy Ground"],
    ...
    Bermuda: ["Hamilton", "Sfantu Gheorghe", "Southampton"],
    Bhutan: [
      "Chhukha",
      "Timphu",
      "Phuntsholing",
    ...
    "Cayman Islands": ["George Town", "Bodden Town", "West Bay"],
    ...
    Comoros: ["Moroni", "Domoni", "Fomboni", "Mutsamudu", "Mitsamiouli"],
    ...
    Djibouti: ["Jibuti", "Dikhil", "´Ali Sabih", "Tajurah", "Ubuk"],
    Dominica: [
      "Roseau",
      "Atkinson",
      "Portsmouth",
    ...
    "Marshall Islands": ["Ebeye", "Jaluit", "Rita"],
    Martinique: [
      "Fort-de-France",
      "Le Lamentin",
      "Ambodifototra",
    ...
    Monaco: ["Monte Carlo", "Monaco-Ville", "Fontvieille", "La Condamine"],
    Mongolia: [
      "Ulaanbaatar",
      "Altaj",
      "Darhan",
    ...
    Montenegro: ["Podgorica", "Nikšić", "Pljevlja", "Budva"],
    ...
    "Norfolk Island": ["Kingston-Blackmans Bay"],
    ...
    "Western Sahara": ["ad-Dakhlah", "al-´Ayun", "Bu Jaydur", "as-Samarah"],
    Yemen: [
      "San´a",
      "´Adan",
      "Ahwar",
